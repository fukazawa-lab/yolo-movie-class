...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_config", type=str, default="/content/yolo-movie-class/src/config/custom.data", help="path to data config file")
    ...
    for epoch in range(opt.epochs):
        ...
        if epoch % opt.checkpoint_interval == 0:
            torch.save(model.state_dict(), f"/content/yolo-movie-class/src/weights/yolov3_ckpt_%d.pth" % epoch)
